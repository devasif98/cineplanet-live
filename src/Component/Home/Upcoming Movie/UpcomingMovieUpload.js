      ...
      .then((result) => {
        fetch(url, {
          ...
          .then((ImageData) => {
            ...
            fetch("https://cineplanet-movie-server.vercel.app/upcoming", {
              method: "POST",
      ...
      <div className="hero my-4 ">
        <div className="hero-content flex-col ">
          <div className="text-center lg:text-left">
            <h1 className="text-5xl font-bold">Uploaded Upcoming Movie</h1>
          </div>
            ...
            <div className="card mt-4 w-full">
              <div className="card-body grid lg:grid-cols-2 grid-cols-1">
                ...
                <div className="form-control">
                  ...
                  >
                    {categories?.map((cate) => (
                      <option className="bg-slate-900">{cate.title}</option>
                    ))}
                  </select>
                </div>
                <div className="form-control">
...
export default UpcomingMovieUpload;
